...
class AdminWindow:
    def __init__(self, root, username, role, dashboard_root):
        self.root = root
        ...
        tk.Button(root, text="Deactivate User").pack(pady=5)
    ...
    def change_password(self):
        ...
        def submit():
            ...
            try:
                ...
                messagebox.showinfo("Sukces", f"Hasło użytkownika {user} zostało zmienione!")
                win.destroy()
            except Exception as e:
                messagebox.showerror("Błąd", str(e))
